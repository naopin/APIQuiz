...
function start() {
    ...
    fetch('https://opentdb.com/api.php?amount=10&type=multiple')
        ...
        .then(questions => {
            question.contents = questions.results;
            // contents.push(questions.results);
            console.log(questions);
            question.contents.forEach(function (content) {
                const tempAnswers = [];
            ...
            console.log(questionItems);
            removedQuestion = question.contents.slice(0, 1);
            showQuestion();
        })
        .catch(err => {
            console.error(err);
